...
<%-- 			     <tr>
				...
				<s:if test="#request.systemDDL!=null && #request.systemDDL.size()>0">
					<s:iterator value="%{#request.systemDDL}" var="list">
						<tr>
							<td class="ta_01" align="center"  width="20%"><s:property value="#list.ddlCode"/></td>
							<td class="ta_01" align="center"  width="60%">
							<input id="itemname" name="itemname" type="text" value="${list.ddlName}"  size="45" maxlength="25"/>
							</td>
							<td class="ta_01" align="center"  width="20%">
