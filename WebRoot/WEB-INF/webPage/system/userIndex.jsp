...
<HTML>
	...
	<body >
		<s:form id="Form1" name="Form1" action="system/elecUserAction_userIndex.do" method="post" style="margin:0px;"> 
				...
				<td class="ta_01" align="center" bgColor="#f5fafe" colspan=3>			
						...
						<table cellspacing="0" cellpadding="1" rules="all" bordercolor="gray" border="1" id="DataGrid1"
							...
							<s:if test="#request.userList!=null && #request.userList.size()>0">
								<s:iterator value="%{#request.userList}" var="user" id="user">								
									<tr onmouseover="this.style.backgroundColor = 'white'" onmouseout="this.style.backgroundColor = '#F5FAFE';">				
										<td style="HEIGHT:22px" align="center" width="20%">
											<s:property value="%{#user.loginName}"/>
										</td>
										<td style="HEIGHT:22px" align="center" width="20%">
											 <a href="#" onclick="openWindow('system/elecUserAction_userEdit.do?userID=<s:property value="#user.userID"/>&viewFlag=1','700','400');">
										...
										<td align="center" style="HEIGHT: 22px" align="center" width="10%">																	
										   <a href="#" onclick="openWindow('system/elecUserAction_userEdit.do?userID=<s:property value="#user.userID"/>','700','400');">
