	...
	function check_null(){
	   ...
	   if(theForm.remark.value.length>250){
         ...
         //
          ...
          var defaultPwd = document.getElementById("loginPwd").defaultValue;
          //alert(defaultPwd);
          if(password == defaultPwd){ //未修改
  ...
  <s:form name="Form1" method="post">
    ...
    <tr>
         ...
         <td class="ta_01" bgColor="#ffffff">
         	<s:textfield name="loginName" id="loginName" maxlength="25" size="20" readonly="true">
         	</s:textfield>
         </td>
	...
	<tr>
		...
		<td class="ta_01" bgColor="#ffffff">
			<s:password name="passwordconfirm" id="passwordconfirm" maxlength="25"  size="22" showPassword="true"></s:password>
		</td>
	</tr>
