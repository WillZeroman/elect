...
<% String popedom = (String)session.getAttribute("global_popedom");
						...
						<DIV class="child" id="KB4Child">
							<TABLE cellSpacing="0" cellPadding="0" width="99%" border="0">
								<TBODY>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="system/elecUserAction_userIndex.do" target="mainFrame">用户管理</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="system/elecRoleAction_home.do" target="mainFrame">角色管理</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="system/elecCommonMsgAction_actingIndex.do" target="mainFrame">待办事宜</A>
										</TD>
									</TR>
									...
									<TR>
										<TD class="box05" onmouseover="backgroundColorChange(this,'white');" onmouseout="backgroundColorChange(this,'');">
											<A class="cl_01" onclick="linkcolorchange(this)" href="system/elecSystemDDLAction_home.do" target="mainFrame">数据字典维护</A>
										</TD>
									</TR>
