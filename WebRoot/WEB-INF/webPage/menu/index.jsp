...
<body onload="ini()">
<s:form action="system/elecMenuAction_home.do" method="post" onsubmit="return check();">
							...
							<table border="0" width="70%" id="table4">
							    <tr>
							    	<td colspan="2" width="200">
							    		<font color="red"><s:fielderror fieldName="error"/></font>
							    	</td>
							    </tr>
								<tr>
